...
import '../services/ad_service.dart' as _i11;
import '../services/device_service.dart' as _i12;
...
Future<_i1.GetIt> $initGetIt(_i1.GetIt get,
  ...
  gh.singletonAsync<_i11.AdService>(() => _i11.AdService.create());
  gh.singletonAsync<_i12.DeviceService>(() => _i12.DeviceService.create(),
      registerFor: {_prod});
  return get;
}
