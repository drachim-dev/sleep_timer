...
public class Messages {
  ...
  public static class RestartRequest {
    ...
    static RestartRequest fromMap(HashMap map) {
      RestartRequest fromMapResult = new RestartRequest();
      Object timerId = map.get("timerId");
      fromMapResult.timerId = (String)timerId;
      return fromMapResult;
    }
  ...
  public static class AlarmRequest {
    ...
    static AlarmRequest fromMap(HashMap map) {
      AlarmRequest fromMapResult = new AlarmRequest();
      Object timerId = map.get("timerId");
      fromMapResult.timerId = (String)timerId;
      return fromMapResult;
    }
  ...
  public static class FlutterTimerApi {
    ...
    public void onRestartRequest(RestartRequest argInput, Reply<Void> callback) {
      BasicMessageChannel<Object> channel =
    ...
    public void onAlarm(AlarmRequest argInput, Reply<Void> callback) {
      BasicMessageChannel<Object> channel =
